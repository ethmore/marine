...
const Navbar = () => {
    ...
    return (
        <div className={`transition-all duration-500 ease-in-out relative top-0 left-0 right-0 lg:sticky flex h-[100px] w-full md:px-8 lg:pl-14 lg:pr-16 z-20 bg-white justify-around lg:justify-between shadow-lg ${navState ? "mb-0" : "mb-[300px]"}`}>
            {/* Logo */}
            <div className=" flex items-center">
                <Link href="/">
                    <Image alt="logo" className="w-[160px] md:w-64" src={logo} />
                </Link>
            </div>
